...
- Name: portal.spec.js >> Portail frontend – Page d'accueil >> affiche la section Agenda et événements à venir
- Location: tests/portal.spec.js:87:3
...
Locator: getByRole('heading', { name: /prochains ateliers/i })
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /prochains ateliers/i })
