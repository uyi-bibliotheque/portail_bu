...
- Name: portal.spec.js >> Portail frontend – Page d'accueil >> affiche la section Guide du Lecteur (4 étapes)
- Location: tests/portal.spec.js:74:3
...
Locator: getByRole('heading', { name: /comment profiter des services/i })
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /comment profiter des services/i })
