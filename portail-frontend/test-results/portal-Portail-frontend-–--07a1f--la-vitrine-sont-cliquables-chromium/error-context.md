...
- Name: portal.spec.js >> Portail frontend – Page d'accueil >> les onglets de la vitrine sont cliquables
- Location: tests/portal.spec.js:64:3
...
Locator: getByRole('button', { name: /acquisitions 2025/i })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /acquisitions 2025/i })
